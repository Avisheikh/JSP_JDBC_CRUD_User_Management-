...
<!--            
            ...
            <section>
              ...
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item waves-effect waves-light a">
                  ...
                  <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Admin History</a>
                </li>
                ...
                <li class="nav-item waves-effect waves-light">
                  ...
                  <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">All Client History</a>
                </li>
                  ...
                  <a class="nav-link" id="profile-tab" data-toggle="tab" href="#ADD_USER" role="tab" aria-controls="profile" aria-selected="false">All Admin History</a>
                </li>
  ...
  <thead>
    ...
    <tr>
      ...
      <th class="th-sm">Login Time
      </th>
      
       <th class="th-sm">Time of Last Access
      </th>
    </tr>
  </thead>
  <tbody  id="myTable">
     <c:forEach var="tempUser" items="${adminHistory}">
         
       
    <tr>
                          <td>${tempUser.historyId}</td>
                        <td>${tempUser.adminUserName}</td>
                        <td>${tempUser.loginTime}</td>
                        <td>${tempUser.lastLoginTime}</td>
  ...
  <tbody  id="myTable" >
     <c:forEach var="tempUser" items="${aclient_history}">
         
       
    <tr>
                          <td>${tempUser.historyId}</td>
                        <td>${tempUser.clientUserName}</td>
                        <td>${tempUser.loginTime}</td>
                        <td>${tempUser.lastLoginTime}</td>
  ...
  <tbody  id="myTable" >
     <c:forEach var="tempUser" items="${admin_history}">
