...
<html lang="en">
 ...
 <!-- BEGIN VENDOR CSS-->
            ...
            <section>
              ...
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item waves-effect waves-light a">
                  ...
                  <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">History List</a>
                </li>
  ...
  <tbody>
     <c:forEach var="tempUser" items="${client_history}">
