        ...
        <div class="row align-items-center justify-content-center site-hero-sm-inner">
          <div class="col-md-7 text-center">
            ...
            <div class="mb-5 element-animate">
              ...
              <p class="bcrumb"><a href="index.jsp">Home</a> <span class="sep ion-android-arrow-dropright px-2"></span>  <span class="current">Log in</span></p>
            </div>
            ...
            <div class="form-wrap">
             ...
             <span class="text-danger"><c:out value="${loginErrorMessage}"/></span>
              ...
              <form action="Login" method="post">
               ...
               <input type="hidden" name="logincommand" value="VALIDATE" >    
                ...
                <div class="row ">
                  <div class="col-md-12 form-group justify-content-center">
                    ...
                    <input type="submit" value="Login" class="btn btn-primary px-5 py-2 text-center">
               ...
               <div style="position: absolute; top: 300px; right: 50px"   >
                     ...
                     <a href="pages/forgetPassword.jsp">
		<p class="text-right  text-danger ">Forget Password</p>
                </a>
