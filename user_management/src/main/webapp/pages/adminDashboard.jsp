...
<!--            
         ...
         <ul class="navbar-nav ">
              <li>
                  ...
                  <a class="btn-link text-uppercase text-dark" href="#">Welcome, ${aUserName.userName}</a> 
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-555">
    <ul class="navbar-nav mx-auto justify-content-center ">
      <li class="nav-item active">
           <c:url var="tempLinkk" value="UserControllerServlet">
            
            <c:param name="command" value="LOAD" />
            <c:param name="adminUserName" value="${aUserName.userName}"/>
      ...
      <li class="nav-item">
            ...
            <c:param name="command" value="adminHistory"/>
               <c:param name="adminUserName" value="${aUserName.userName}"/>
        ...
        <a class="nav-link" href="${templinkk}">List User</a>
      </li>
      
      |
      
         <li class="nav-item">
              <c:url var="reportlinkk" value="ReportServlet">
            
            <c:param name="reportCommand" value="dateList"/>
         
           
        </c:url>
             
        <a class="nav-link" href="${reportlinkk}">Report</a>
      </li>
